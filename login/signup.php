...
$a7 = $geo["geoplugin_countryName"];	
		...
		else
		{
			...
			{			
				...
				Hello $uname,
				<br /><br />
				Welcome to MAT Solutions Inc<br/>
				To complete your registration  please , just click following link<br/>
				<br /><br />
				<a href='http://www.matsolutionsinc.com/login/verify.php?id=$id&code=$code'>Click HERE to Activate </a>
				<br /><br />
				Thanks,";
...
<body  class=" "style="background:#02b0e2">
	<div class="container">
		<div class="signup-form-container">
			...
			<form class="" method="post"oninput="result.value=!!txtpass2.value&&(txtpass.value==txtpass2.value)?'Match!':'Nope!'" >
				...
				<div class="form-body">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input  type="text" id="name" class="form-control" placeholder="Zip Code "  pattern=".{2,20}" name="s6" maxlength="40"  required minlength="2">
						</div>
						<span class="help-block" id="error"></span>
					</div>				
					</div>				
                   <div class="form-footer">				
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
							<input  type="text" id="name" class="form-control" placeholder="Username" name="txtuname" maxlength="40"pattern=".{5,10}" required minlength="5" maxlength="10" title="Minimum 5 digit & Maximum 10 digit required">
						</div>
						<span class="help-block" id="error"></span>
					</div>
				...
				<div class="form-footer">
					<button type="submit" class="btn btn-info" id="btn-signup"name="btn-signup"><span class="glyphicon glyphicon-log-in"></span> Sign Me Up</button>
										<a href="index" style="float:right;" class="btn btn-large"> <span class="glyphicon glyphicon-tag"></span> Sign In    </a>
				</div>
