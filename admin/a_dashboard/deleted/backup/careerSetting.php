...
<?php
	...
	if(isset($_POST['updateNow'])){
		...
		$sqlx = "UPDATE job SET a1='$c1', a2='$c2', a3='$c3', a5='$c5', a7='$age', a8='$c8' , a9='$diff' WHERE a6='$ID' ";
				...
				<section class="invoice wow fade wow fadeIn animated sb"style="margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							...
							<small class=" "><i><b>Job Title: </b><input  style="border:0px;  width:300px; padding-left:5px; " type="text"value="<?php  echo $c8; ?>" name="c8">  </i></small>
