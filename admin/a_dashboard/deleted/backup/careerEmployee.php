...
function random_numbers($digits) {
	...
	if(isset($_POST['denied'])){
		$xx='1';
		$xx2=$_POST['xx2'];
		$sqlx = "UPDATE career SET b10='$xx', b13='$xx'  WHERE id='$xx2' ";
...
// Row count from table Total Applicant
	include('../config.php');
	$applicant='Male';
    $qryTotal = "SELECT * FROM  career  where b5=1 AND b6=0 AND b7=1 AND b8=0 AND b9=0 AND b10=0 AND b12=0 ";
	...
	$applicant='Female';
    $qryTotalFemale = "SELECT * FROM  career  WHERE a4 = '$applicant' ";
							...
							<div class="col-xs-6">
								...
								<div class="col-xs-3">
									 <form class="row no-print " method="POST">
										...
										<input type="submit"style="width:100%;" name="denied" value="View CV" class="btn bg-purple btn-flat">
								 	</form>	
								</div>	
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
  ...
  <!--       <button  class="small-box-footer"data-toggle="modal" data-target="#modal-primary" style="border:0px;width:100%;">View More <i class="fa fa-arrow-circle-right"></i></button>-->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo($female); ?><sup style="font-size: 20px">%</sup></h3>
              <p>Female Applicant Number</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
