...
<?php
	...
	if(isset($_POST['check'])){
		...
		//$c3=$_POST['c3'];//Status:
		//$c4=$_POST['c4'];//Create Date
		
		$c5="tusar";//Admin
		$c6= rand();//id of job
	    $c7 =implode(',', $_POST['age']);//Positions 
		//$sqlx = "UPDATE career SET a15='$age' WHERE id='3' ";
		$sqlx = "INSERT INTO job (a1,a2,a3,a4,a5,a6,a7) VALUES ('$c1','$c2','$c3','$c4','$c5','$c6','$c7')";
		try{
			include('../config.php');
			$update_Result = mysqli_query($conn, $sqlx);			
			if($update_Result)
				...
				<section class="invoice wow fade wow fadeIn animated"style="margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							...
							<img class="img-responsive" src="../../img/logo.png" alt="Chania" width="120"  >  <aa style="color:gray;"><i class="fa fa-globe"></i>Job Create And Management</aa>	</center> 
							<small class="pull-centered"><i>Job ID (Unique): 1578</i></small>
							</h2>
						</div>
					</div>
									...
									<tr>
										...
										<td> 
											<div class="input-group date   bg-purple btn-flat ">
												...
												<input type="text"name="c2" class="form-control pull-right" id="datepicker">
											</div>
										</td>					
										<td><b>Status:</b></td>
										<td>                        
											<select name="c3"class="  bg-olive btn-flat">                             
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										...
										<td>
										<input type="date" name="c4" value="<?php echo date('Y-m-d'); ?>" />
										</td>
									</tr>
									<tr>
										<th>Created By:</th>
							...
							<div class="col-xs-12">		
								...
								<div class="col-xs-6">		
									...
									<div class="col-xs-3">
										...
										<input type="submit" name="check" value="Update" style="width:120%"class="btn bg-olive btn-flat">
									</form>	
								</div>
								...
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
										...
										<input type="submit" name="denied" style="width:100%" value="Delete" class="btn bg-maroon btn-flat">
									</form>	
								</div>
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
						...
						<div class="col-xs-9">
							...
							<form class="  " method="POST">
								<div class="col-xs-3">		
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"style="padding:0;margin:0;"><input id="checkbox1"  name="age[0]" value="HTML" type="checkbox" <?php if( in_array('HTML',$checked)) echo "checked";?>>
												<label for="checkbox1">HTML</label>
											</div>                   
											
										</li>
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"><input id="checkbox2"  name="age[1]"  value="CSS" type="checkbox" <?php if( in_array('CSS',$checked)) echo "checked";?>>
								...
								<input  type="submit" name="check" value="check" class="btn bg-maroon btn-flat ">
