...
<?php
	...
	if(isset($_POST['check'])){
		...
		$age =implode(',', $_POST['age']);//Positions
		$sqlx = "INSERT INTO job (a1,a2,a3,a4,a5,a6,a7) VALUES ('$c1','$c2','$c3','$c4','$c5','$c6','$age')";
		try{
			include('../config.php');
			$update_Result = mysqli_query($conn, $sqlx);			
			if($update_Result)
				...
				<section class="invoice wow fade wow fadeIn animated"style="margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							...
							<small class="pull-centered"><i>Job ID (Unique): <?php echo $c6; ?></i></small>
							</h2>
						</div>
					</div>
									...
									<tr>
										...
										<td> 
											<div class="input-group date   bg-purple btn-flat ">
												...
												<input required type="text"name="n2" class="form-control pull-right" id="datepicker">
											</div>
										</td>					
										<td><b>Status:</b></td>
										<td>                        
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tr>
										...
										<td>
										<input type="date" name="n4" value="<?php echo date('Y-m-d'); ?>" />
										</td>
									</tr>
									<tr>
										<th>Created By:</th>
