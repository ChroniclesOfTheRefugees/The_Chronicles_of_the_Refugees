								...
								<div class="col-xs-6">		
									<ul class="list-group list-group-flush" >
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"style="padding:0;margin:0;"><input id="checkbox1"  name="age[0]" value="Forum Management" type="checkbox" <?php if( in_array("Forum Management",$age)) echo "checked";?>>
												<label for="checkbox1">Forum Management</label>
											</div>                   
											
										</li>
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"><input id="checkbox2"  name="age[1]"  value="Contact & Questions" type="checkbox" <?php if( in_array("Contact & Questions",$age)) echo "checked";?>>
												<label for="checkbox2">Contact & Questions</label>
											</div>    
										</li>
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"><input id="checkbox3"  name="age[2]"  value="Refugee Management" type="checkbox" <?php if( in_array("Refugee Management",$age)) echo "checked";?>>
												<label for="checkbox3">Refugee Management</label>
											</div> 
										</li>
										<li class="list-group-item">
											<div class="checkbox checkbox-success checkbox-circle" style="padding:0;margin:0;"><input id="checkbox4"  name="age[3]" value="Manage User" type="checkbox" <?php if( in_array("Manage User",$age)) echo "checked";?>>
												<label for="checkbox4">Manage User</label>
											</div> 
										</li>
									</ul>	
								</div>
