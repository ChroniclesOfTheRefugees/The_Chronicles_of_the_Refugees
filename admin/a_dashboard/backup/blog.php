...
<?php
	...
	function phpAlert($msg) {
		...
		echo '<script type="text/javascript">alert("' . $msg . '")</script>';
								...
								$qry1="select * from blog LIMIT 1, 18446744073709551615";
	...
	if(isset($_POST['send'])){
								...
								//Query to be executed;
								$qry7="select * from subscribe  where s1='no'";
								//Performs a query on the database;
										...
										<form class="form-horizontal">
											<div class="box-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" name="a5" ng-model="a5" class="form-control"  placeholder="Image Name ...">
							...
							<div class="col-md-12 "style="" >
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">Blog Alert Mailer</h3>
										</div>
									...
									<div class="col-md-12">
										<table class="table table-bordered"style="width: 100%;">
											...
											<tr ng-repeat="x in names">
												<td>{{x.id}}</td>
												<td  style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">{{x.a11}}</td>
												<td>{{x.a18}}</td>
												<td style="  white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 120px;">{{x.a7}}</td>												
												
												<td>
													<button class="btn btn-success btn-xs" ng-click="update_data( x.a7, x.id, x.a9, x.r1, x.a5 )">
			...
			app.controller("controller", function($scope, $http) {
				...
				$scope.insert = function() {
					...
					if ($scope.a1 == null) {
						...
						} else if ($scope.a5 == null) {
						alert("Enter Image Name");
						} else {
						$http.post(
						"include/blog/insert.php", {
							'a1': $scope.a1,
							'a2': $scope.a2,
				...
				$scope.show_data = function() {
					$http.get("include/blog/display.php")
					.success(function(data) {
						$scope.names = data;
					});
				}
				$scope.update_data = function(a7, id, a9, r1, a5) {
				...
				$scope.delete_data = function(id) {
					if (confirm("Are you sure you want to delete?")) {
						$http.post("include/blog/delete.php", {
							'id': id
						})
						.success(function(data) {
							alert(data);
