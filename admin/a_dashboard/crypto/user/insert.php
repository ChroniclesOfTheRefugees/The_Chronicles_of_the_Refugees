...
if (count($info) > 0) {
    ...
    if ($btn_name == "Insert") {
        $query = "INSERT INTO tbl_users(a1, a2, a3, a4, a5, a6, a7) VALUES ('$a1', '$a2', '$a3', '$a4', '$a5', '$a6', '$a7')";
    ...
    if ($btn_name == 'Update') {
        $id    = $info->id;
        $query = "UPDATE tbl_users SET a1='$a1', a2 = '$a2', a3 = '$a3', a4 = '$a4', a5 = '$a5', a6 = '$a6', a7 = '$a7'  WHERE id = '$id'";
        if (mysqli_query($conn, $query)) {
