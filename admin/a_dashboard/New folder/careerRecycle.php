...
<?php
	...
	if(isset($_POST['approve'])){
		$h='';
		$xx2=$_POST['xx1'];
		$sqlx = "UPDATE career SET b9='0',b10='0',b11='$h' ,b12='$h' ,b13='$h' WHERE id='$xx2' ";
...
// Row count from table Total Applicant
    ...
    $qry="select * from career where b5=1 AND b7=1 AND b13=1 OR b10=1 OR b9=1 ";
	$resultTotal=mysqli_query($conn,$qry);
	$c1=mysqli_num_rows($resultTotal);  //Total
 
    $qry="select * from career where b5=1 AND b7=1 AND b13=1";
	$resultTotal=mysqli_query($conn,$qry);
	$c2=mysqli_num_rows($resultTotal); //from leave j
 
    $qry="select * from career where b5=1 AND b10=1 ";
	$resultTotal=mysqli_query($conn,$qry);
							...
							<div class="box">
								...
								<div class="box-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php		
												$qry="select * from career where  b10=1  OR b13=1 OR b9=1   ";
