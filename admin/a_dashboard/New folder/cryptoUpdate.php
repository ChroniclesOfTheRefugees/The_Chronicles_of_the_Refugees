...
<?php
	...
	function phpAlert($msg) {
		...
		echo '<script type="text/javascript">alert("' . $msg . '")</script>';
								...
								$qry1="select * from uptodate LIMIT 1, 18446744073709551615";
				...
				<section class="content container-fluid"style="padding:0px;background-color:#ecf0f5;">								
					<div class="col-md-12" style="padding-top:20px;">
						<div ng-app="sa_app" ng-controller="controller" ng-init="show_data()">									
							...
							<div class="col-md-5 "style="margin-top:-30px;" >
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">TO DO LIST Form</h3>
										</div>
							...
							<input type="text"name="a1" ng-model="a1"  class="form-control  validate" class="form-control"    >
								<label for="last-name"style="color:lightgray;">Heading</label>
							</div>									
							<div class="input-field col s6">
							<input type="text"name="a2" ng-model="a2"  class="form-control  validate" class="form-control"    >
								<label for="Tag"style="color:lightgray;">Tag</label>
							</div>									
							<div class="input-field col s6">
							<input type="text"name="a3"    ng-model="a3"  class="form-control  validate" class="form-control"    >
								<label for="Tag"style="color:lightgray;">Brief</label>
							</div>		
		...
		<script>  
			...
			app.controller("controller", function($scope, $http) {
				...
				$scope.show_data = function() {
					$http.get("crypto/update/display.php")
					.success(function(data) {
						$scope.names = data;
					});
				}
				...
				$scope.delete_data = function(id) {
					if (confirm("Are you sure you want to delete?")) {
						$http.post("crypto/update/delete.php", {
							'id': id
						})
						.success(function(data) {
							alert(data);
