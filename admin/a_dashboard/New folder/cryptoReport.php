...
<?php $currentPage1 = 'Crypto';  
	...
	if(!empty($_FILES['uploaded_file2']))
	{
		...
		$fname =basename( $_FILES['uploaded_file2']['name']);
	...
	function phpalert($msg) {
		...
		echo '<script type="text/javascript">alert("' . $msg . '")</script>';
								...
								$qry1="select * from report LIMIT 1, 18446744073709551615";
							...
							<div class="col-md-12 " style="margin-top:-30px;">
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">Crypto report Form</h3>
										</div>
										...
										<form class="form-horizontal">
											<div class="box-body">
												...
												<div class="form-group ">
													<label for="inputPassword3" class="col-sm-2 control-label">Pdf </label>												
													<div class="col-sm-10">
														<input type="text" class="form-control" name="a4" ng-model="a4"  placeholder="Name.pdf"> 														
													</div>													
												</div>
												<div class="form-group ">
													<label for="inputPassword3" class="col-sm-2 control-label">ICON </label>												
													<div class="col-sm-10">
														<input type="text" class="form-control" name="a7" ng-model="a7"  placeholder="Name.extension"> 														
													</div>													
												</div>												
							...
							<div class="col-md-12 " >
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">ICON Uploader (size: 90*90 px)</h3>
										</div>
										
										
										
										
										<form enctype="multipart/form-data" action="cryptoReport.php" method="POST">
											<div class="col-xs-3">
												<button type="submit" value="Upload">Upload</button>
											</div>
											<div class="col-xs-3">
												<input type="file" name="uploaded_file2" style="color: gray;padding-bottom:10px;" ></input>
											</div>				       
										</form>
							...
							<div class="col-md-12 " >
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">PDF Uploader</h3>
										</div>
									...
									<div class="col-md-12">
										<table class="table table-bordered"style="width: 100%;">
											...
											<tr ng-repeat="x in names">
												...
												<td>
													<button class="btn btn-success btn-xs" ng-click="update_data( x.a1, x.id, x.a2, x.a3, x.a4, x.a7 )">
			...
			app.controller("controller", function($scope, $http) {
				...
				$scope.insert = function() {
					...
					if ($scope.a1 == null) {
						...
						alert("Enter Your Pdf name");
						}else if ($scope.a7 == null) {
						alert("Enter Your Icon name");
						}else {
						$http.post(
						"crypto/report/insert.php", {
							'a1': $scope.a1,
							'a2': $scope.a2,
							'a3': $scope.a3,
							'a4': $scope.a4,
				...
				$scope.show_data = function() {
					$http.get("crypto/report/display.php")
					.success(function(data) {
						$scope.names = data;
					});
				}
				$scope.update_data = function(a1, id, a2, a3, a4, a7) {
				...
				$scope.delete_data = function(id) {
					if (confirm("Are you sure you want to delete?")) {
						$http.post("crypto/report/delete.php", {
							'id': id
						})
						.success(function(data) {
							alert(data);
