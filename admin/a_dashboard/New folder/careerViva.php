...
function random_numbers($digits) {
 ...
 $contact='';
	...
	if(isset($_POST['approve'])){
		...
		$xx2=$_POST['xx1'];
		$sqlx = "UPDATE career SET a16='$a16',a17='$a17',a18='$a18',a19='$a19',a20='$a20', b7='1' WHERE id='$xx2' ";
...
// Mail	
			...
			Hello $contact,
			<br /><br />
			You are selected as permanent employee.
...
// end mail	
	...
	if(isset($_POST['denied'])){
		$xx='1';
		$xx2=$_POST['xx2'];
		$sqlx = "UPDATE career SET b10='$xx' WHERE id='$xx2' ";
...
// Row count from table Total Applicant
	include('../config.php');
	$applicant='Male';
    $qryTotal = "SELECT * FROM  career  WHERE b5=1 AND b6=0 AND b7=0 AND b8=0 AND b9=0 AND b10=0 AND a4 = '$applicant' ";
	...
	$applicant='Female';
    $qryTotalFemale = "SELECT * FROM  career  WHERE b5=1 AND b6=0 AND b7=0 AND b8=0 AND b9=0 AND b10=0 AND a4 = '$applicant' ";
				...
				<section class="invoice wow fade wow fadeIn animated"style="margin-top:0px;margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							...
							<img class="img-responsive" src="../../img/logo.png" alt="Chania" width="120"  >  <aa style="color:gray;"><i class="fa fa-globe"></i> Selected for Viva</aa>	</center> 
					...
					<div class="row invoice-info">
						...
						<div class="col-sm-5 invoice-col  "style=" margin-right:10px;margin-bottom:10px;">
							...
							<center style="background-color:lightgray;">Fillup By Office</center>
								...
								<b>&nbsp;Employee ID:</b> <input class=""style="border:0;" type="text" name="a16" value="<?php   echo $eid  ; ?>">		</br>
								<b>&nbsp;Responsibility(final):</b> 
					<select name="a17">          
                            <option value="Graphics Designer"<?php if($a17=="Graphics Designer") echo "selected";?>>Graphics Designer</option>                        
                            <option value="Web Developer"<?php if($a17=="Web Developer") echo "selected";?>>Web Developer</option> 
					    	<option value="Android Developer"<?php if($a17=="Android Developer") echo "selected";?>>Android Developer</option>
					    	<option value="Android Developer"<?php if($a17=="Android Developer") echo "selected";?>>Android Developer</option>                        
                            <option value="Game Developer"<?php if($a17=="Game Developer") echo "selected";?>>Game Developer</option>
					    	<option value="System Designer"<?php if($a17=="System Designer") echo "selected";?>>System Designer</option>
					    	<option value="English Specialist"<?php if($a17=="English Specialist") echo "selected";?>>English Specialist</option>           
					    	<option value="Customer Support"<?php if($a17=="Customer Support") echo "selected";?>>Customer Support</option>           
					    	<option value="Marketing Officer"<?php if($a17=="Marketing Officer") echo "selected";?>>Marketing Officer</option>           
                        </select>
								
								</br>
								<b >&nbsp;Position:</b> 
					<select style="padding-top:3px;" name="a18">                  
                            <option value="Junior Officer"<?php if($a18=="Junior Officer") echo "selected";?>>Junior Officer</option>                        
                            <option value="Senior Officer"<?php if($a18=="Senior Officer") echo "selected";?>>Senior Officer</option> 
					    	<option value="Executive"<?php if($a18=="Executive") echo "selected";?>>Executive</option>
					    	<option value="Manager"<?php if($a18=="Manager") echo "selected";?>>Manager</option>                        
                        </select>
								</br>
								 
								<b>&nbsp;Salary: </b><input class=""style="border:0;"autofocus type="text" name="a19" value=" <?php   echo $a19  ; ?>">		</br>
								<b>&nbsp;Join Date:</b><input type="date" name="a20"   class="form-control pull-right" value="<?php echo date('Y-m-d'); ?>" />
</br>
								<b>&nbsp;Leave Date:</b>  <input class=""style="border:0;"disabled type="text" name="a21" value="<?php   echo $a20  ; ?>">	</br>
							<b>&nbsp;Approved By:</b> Admin
							</address>
							
										
										<input class="invisible" type="text" name="xx1" value="<?php echo $id  ; ?>">		
										<input class="invisible" type="text" name="email" value="<?php echo $p2  ; ?>">		
							 ...
							 <div class="col-xs-4">
								...
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
										...
										<input type="submit"style="width:100%;" name="denied" value="Denied" class="btn bg-maroon btn-flat">
									</form>	
								</div>
								<div class="col-xs-2">
									<form class="row no-print " method="POST">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Male Applicant Call for Viva</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Female Applicant Call for Viva</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Selected For Viva</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php		
												...
												$qry="select * from career where b5=1 AND b6=0 AND b7=0 AND b8=0 AND b9=0 AND b10=0  ";
