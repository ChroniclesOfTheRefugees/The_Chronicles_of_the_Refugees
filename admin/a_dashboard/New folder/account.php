							...
							<div class="box-header with-border">
								...
								<div  class=" fixed">
									<div class="box box-info box box-solid box-default">
										...
										<div class="box-header with-border">
											<h3 class="box-title">Change Lockscreen PIN</h3>
										</div>
										...
										<form class="form-horizontal"method="POST" action="account">
											<div class="box-body">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="password"name="x1" ng-model="a1"  class="form-control"   placeholder="Old PIN">
													</div>
												</div>																		
												<div class="form-group">
												
													<div class="col-sm-10">
														<input type="password"name="x2" ng-model="a1" pattern=".{4,}"   required title="4 characters minimum"  class="form-control"   placeholder="New PIN">
													</div>
												</div>													
											</div>
											<div class="box-footer">
												 
												<button type="submit" name="md"     class="btn btn-info pull-right">Update</button>
											</div>
										</form>									
									</div>
								</div>
