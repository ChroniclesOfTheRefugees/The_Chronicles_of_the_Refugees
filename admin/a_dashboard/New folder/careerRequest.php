...
// Row count from table Total Applicant
	include('../config.php');
	$applicant='Male';
    $qryTotal = "SELECT * FROM  career  WHERE b5=0 AND b6=0 AND b7=0 AND b8=0 AND b9=0 AND b10=0 AND a4 = '$applicant' ";
							...
							<div class="box">
								...
								<div class="box-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php		
												$qry="select * from career where b5=0 AND b6=0 AND b7=0 AND b8=0 AND b9=0 AND b10=0 AND b10=0 AND b10=0  ";
