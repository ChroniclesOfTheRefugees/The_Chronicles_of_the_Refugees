					...
					<div class="col-md-12" style="padding-top:20px;">
						<div ng-app="sa_app" ng-controller="controller" ng-init="show_data()">									
							...
							<div class="col-md-12"style="background-color:#fff;">
									...
									<div class="box box-info box box-solid box-default">
										<div class="box-header with-border">
											<h3 class="box-title">User Table (Premium)</h3>
										</div>
								</div>
							</div>
								<div class="box box-success ">								
										<table class="table table-bordered"style="width: 100%;">
											...
											<tr ng-repeat="x in names">
												...
												<td  style=" text-overflow: ellipsis;">{{x.p1}}</td>
												<td  style=" text-overflow: ellipsis;">{{x.p2}}</td>
