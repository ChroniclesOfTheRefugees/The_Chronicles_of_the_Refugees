...
$diff = $date2->diff($date1)->format("%a");
		...
		$sqlx = "INSERT INTO job (a1,a2,a3,a5,a6,a7,a8,a9) VALUES ('$c1','$c2','$c3','$c5','$c6','$age','$c8','$diff')";
		try{
			include('../config.php');
			$update_Result = mysqli_query($conn, $sqlx);			
			if($update_Result)
	...
	$applicant='Disable';
    $qryTotalFemale2 = "SELECT * FROM  job WHERE a3 = '$applicant'  LIMIT 1,78787878 ";
	$resultTotal2=mysqli_query($conn,$qryTotalFemale2);
	$count3=mysqli_num_rows($resultTotal2);
	...
	<body  class="hold-transition skin-blue sidebar-mini skin-blue sidebar-mini wysihtml5-supported fixed">
		<div class="wrapper"scroll="no" style="overflow: hidden">
			...
			<div class="content-wrapper"style="background-color:#ecf0f5;">
				...
				<!-- View -->
				<!-- Update Job --><?php if ( $createjob === '5') {echo ''; }else{echo '<!--';}	 ?>
				<section class="invoice wow fade wow fadeIn animated"style="margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							...
							<small class=" "><i>Job Title: <input autofocus style="border:0px; background-color:#f0f0f0;width:300px; padding-left:5px; " type="text"value="<?php  echo $c8; ?>" name="c8">  </i></small>
							</h2>
						</div>
					</div>
					<div class="row">
							...
							<div class="col-xs-12">		
								...
								<div class="col-xs-6">		
									...
									<div class="col-xs-3">
										...
										<input type="submit" name="update" value="Update" style="width:120%"class="btn bg-olive btn-flat">
								</div>
								</form>
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
										<input class="invisible" type="text" name="xx2" value="<?php echo $id  ; ?>">		
										<input type="submit" name="delete" style="width:100%" value="Delete" class="btn bg-maroon btn-flat">
									</form>	
								</div>
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
				...
				</section>  		<?php if ( $createjob === '5') {echo ''; }else{echo '-->';}	 ?>
						
			
			
			
				<!-- Create A New Job --><?php if ( $createjob === '1') {echo '<!--'; }else{echo '';}	 ?>
				<section class="invoice wow fade wow fadeIn animated"style="margin-top:10px;    border: 2px solid #01ade1;">
					<div class="row">
						<div class="col-xs-12">
							<h2 class="page-header" >  <center> 
								...
								<tbody >
									<tr>
										...
										<td> 
											...
											<input type="date" name="n2" class="form-control pull-right" value="<?php echo date('Y-m-d'); ?>" />
											</div>
										</td>					
										<td><b>Status:</b></td>
										<td>                        
					...
					<div class="row">			
						...
						<div class="row no-print well">
							<div class="col-xs-12">		
								...
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
										<input class="invisible" type="text" name="xx2" value="102">		
				...
				</section>  		<?php if ( $createjob === '1') {echo '-->'; }else{echo '';}	 ?>
					...
					<div class="  row no print">
						...
						<div class="col-lg-3 col-xs-6">
							<div class="small-box  bg-aqua">
								...
								<div class="col-xs-3">
									<form class="row no-print " method="POST">
										<input class="invisible" type="text" name="v1" value="100">		
										<input type="submit" name="viewthis" value="view" class="btn bg-maroon btn-flat">
									</form>	
								</div>
